...
| 6 | Listeria - PulseNet | A set of Listeria outbreaks with allele calls from BioNumerics | Test whole genome MLST caller; outbreak clustering | [listeria-outbreak.tsv](/datasets/listeria-outbreak.tsv) |  |
